...
<body>
  <div class="wrap">
    <div class="header_top">
      <div class="logo">
        <a href="index.php">
          <h1 style="font-size:50px;color:#360187; font-family: Poppins; font-weight: bold;">G-Hub PH<span
              style="font-size: 20px; position: absolute; margin-left: 8px;"> &#8482</span></h1>
        </a>
      </div>
      <div class="header_top_right">
        <div class="search_box">
          <form id="searchName" action="index.php" method="post">
            <input type="text" name="valueToSearch" value="Search for Products" onfocus="this.value = '';"
